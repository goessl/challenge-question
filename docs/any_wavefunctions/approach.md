...
3. use it to show that there can be ensembles with the same particle density and different kinetic energies and
4. discuss the consequences and adapt the roadmap of this never ending nightmare.
