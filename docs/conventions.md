...
- Enumerate particles with $k\in\left\{1, 2, \dots, N\right\}$.
    ...
    $\left\{\phi_k\right\}_{k\in\left\{1, 2, \dots, N\right\}}=\left\{\phi_1, \phi_2, \dots, \phi_N\right\}$
...
- Enumerate series with $j\in\left\{0, 1, \dots, D\right\}$.
    ...
    $\left\{\ket{j}\right\}_{j\in\left\{0, 1, \dots, D\right\}}=\left\{\ket{0}, \ket{1}, \dots, \ket{D}\right\}$.
